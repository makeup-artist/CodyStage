...
(
    ...
    picture     varchar(100)                            not null comment '商品首页图片url',
    description varchar(300)                            not null comment '商品概要描述',
    details     varchar(4096) default ''                null comment '商品详细描述',
    type        tinyint unsigned                        not null comment '1口红 2底妆 3眉毛 4美瞳 5发色',
