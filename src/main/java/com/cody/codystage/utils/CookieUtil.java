...
public class CookieUtil {
    ...
    private static void doSetCookie(HttpServletRequest request, HttpServletResponse response, String cookieName,
        ...
        try {
            ...
            setCookieValue(request,response,cookieName,cookieValue,cookieMaxage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static void setCookieValue(HttpServletRequest request, HttpServletResponse response, String cookieName,
                                       String cookieValue, int cookieMaxage){
